...
PROMETHEUS_CONFIG_FILE=${PROMETHEUS_CONFIG_FILE:-/opt/containers/config/prometheus.yml}
PROMETHEUS_DATA_DIR=${PROMETHEUS_DATA_DIR:-/opt/containers/data}
...
if [ -n "${PROMETHEUS_WEB_CONFIG_FILE}" ]; then
    PROMETHEUS_ARG_LIST+=(
