...
# PostgreSQL readiness configuration
export POSTGRESQL_READY_MAX_ATTEMPTS="${POSTGRESQL_READY_MAX_ATTEMPTS:-30}"
export POSTGRESQL_READY_ATTEMPT_INTERVAL="${POSTGRESQL_READY_ATTEMPT_INTERVAL:-1}"
