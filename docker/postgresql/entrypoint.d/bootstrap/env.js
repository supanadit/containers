...
const PGBACKREST_ARCHIVE = env.isTruthy("PGBACKREST_ARCHIVE_ENABLE", "true");
const SLEEP_MODE = env.isTruthy("SLEEP_MODE");
const CITUS_ENABLE = env.isTruthy("CITUS_ENABLE");
...
// Timing / timeouts.
const TIMEOUT = parseInt(env.get("TIMEOUT", "30"), 10);
const PG_READY_MAX_ATTEMPTS = parseInt(env.get("POSTGRESQL_READY_MAX_ATTEMPTS", "30"), 10);
const PG_READY_ATTEMPT_INTERVAL = parseInt(env.get("POSTGRESQL_READY_ATTEMPT_INTERVAL", "1"), 10);
const PGBACKREST_AUTO_TIMEZONE = env.get("PGBACKREST_AUTO_TIMEZONE", "UTC");
const PGBACKREST_AUTO_FIRST_INCR_DELAY = parseInt(env.get("PGBACKREST_AUTO_FIRST_INCR_DELAY", "120"), 10);
