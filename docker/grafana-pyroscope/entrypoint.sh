...
# Data paths
PYROSCOPE_DATA_PATH=${PYROSCOPE_DATA_PATH:-/opt/containers/data}
PYROSCOPE_COMPACTOR_DATA_DIR=${PYROSCOPE_COMPACTOR_DATA_DIR:-/opt/containers/data/compactor}
...
PYROSCOPE_STORAGE_FILESYSTEM_DIR=${PYROSCOPE_STORAGE_FILESYSTEM_DIR:-/opt/containers/data/shared}
