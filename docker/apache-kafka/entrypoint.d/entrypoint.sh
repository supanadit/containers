...
# Default directories
export DEFAULT_KAFKA_DATA_DIR="${DEFAULT_KAFKA_DATA_DIR:-/opt/containers/data}"
export DEFAULT_KAFKA_LOG_DIR="${DEFAULT_KAFKA_LOG_DIR:-/opt/containers/logs}"
export DEFAULT_KAFKA_CONFIG_DIR="${DEFAULT_KAFKA_CONFIG_DIR:-/opt/containers/config}"
export DEFAULT_KAFKA_RUN_DIR="${DEFAULT_KAFKA_RUN_DIR:-/opt/containers/run}"
...
export KAFKA_LOG_DIRS="${KAFKA_LOG_DIRS:-/opt/containers/data}"
